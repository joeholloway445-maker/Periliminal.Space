...
const PROPS := {
	"market": [
		...
		["plastic_crate_02", Vector3(-4.3, 0, 0.4), 0.2],
		["barrel_03", Vector3(4.6, 0, -3.8), 0.0],
		["wooden_crate_01", Vector3(3.9, 0, -1.2), 0.4],
		["metal_trash_can", Vector3(5.2, 0, 3.4), 0.0],
		["planter_box_01", Vector3(4.4, 0, 2.6), 0.0],
	],
	"bank": [
		["metal_office_desk", Vector3(0, 0, -2.6), 0.0],
		["modern_arm_chair_01", Vector3(-1.8, 0, -1.0), 3.14],
		["modern_arm_chair_01", Vector3(1.8, 0, -1.0), 3.14],
		["drawer_cabinet", Vector3(-5.4, 0, -4.2), 1.57],
		["modern_wooden_cabinet", Vector3(5.2, 0, -3.6), -1.57],
		["fancy_picture_frame_01", Vector3(0, 0, -5.6), 0.0],
	],
	"armorer": [
		["old_military_crate", Vector3(-4.8, 0, -3.0), 0.3],
		["industrial_storage_cart", Vector3(4.4, 0, -2.2), 0.0],
		["metal_tool_chest", Vector3(-4.6, 0, 1.4), 0.0],
		["ammo_box", Vector3(3.6, 0, 2.2), 0.5],
		["katana_stand_01", Vector3(0, 0, -5.2), 0.0],
	],
	"blacksmith": [
		["barrel_stove", Vector3(-4.6, 0, -3.4), 0.0],
		["wooden_barrels_01", Vector3(4.6, 0, -3.2), 0.0],
		["bench_vice_01", Vector3(-3.2, 0, -5.0), 0.0],
		["metal_toolbox", Vector3(3.9, 0, 1.8), 0.9],
		["metal_jerrycan", Vector3(5.0, 0, 2.8), 0.0],
	],
	"wager_hall": [
		["painted_wooden_sofa", Vector3(-3.8, 0, -3.6), 0.0],
		["modern_coffee_table_01", Vector3(-3.8, 0, -1.4), 0.0],
		["mid_century_lounge_chair", Vector3(-1.2, 0, -3.2), 0.8],
		["bar_chair_round_01", Vector3(4.2, 0, -2.6), 0.0],
		["bar_chair_round_01", Vector3(4.2, 0, 0.2), 0.0],
		["round_wooden_table_01", Vector3(4.2, 0, -1.2), 0.0],
	],
	"stockyards": [
		["wooden_crate_02", Vector3(-5.2, 0, -4.0), 0.0],
		["barrel_03", Vector3(5.0, 0, -4.0), 0.0],
		["wooden_crate_01", Vector3(-4.0, 0, 2.4), 0.3],
		["ladder_sectioned_01", Vector3(5.4, 0, 0.6), 0.0],
	],
}
